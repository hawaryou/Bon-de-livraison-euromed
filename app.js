...
async function buildPdf(data){
  ...
  if(data.destinataireAbsent){
    ...
    const boxH=58;pdf.setDrawColor(...lineColor);pdf.rect(53,y,104,boxH);try{pdf.addImage(data.deliveryPhoto,'JPEG',55,y+2,100,54,{compression:'MEDIUM'});}catch(e){}y+=boxH+7;
  }else{
    pdf.setFillColor(248,251,252);pdf.setDrawColor(...lineColor);pdf.roundedRect(12,y,186,48,2,2,'FD');pdf.setFont('helvetica','bold');pdf.setFontSize(9);pdf.setTextColor(...navy);pdf.text('SIGNATURE DU CLIENT',105,y+7,{align:'center'});pdf.rect(58,y+11,94,32);try{pdf.addImage(data.signature,'PNG',60,y+12,90,30);}catch(e){}y+=54;
  }
